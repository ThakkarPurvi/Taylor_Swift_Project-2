...
@app.route('/share_feedback', methods=['GET', 'POST'])
def share_feedback():  
    return render_template("share_feedback.html")

@app.route('/fanclub', methods=['GET','POST'])
def fanclub():
    return render_template('fanclub.html')

@app.route('/fanclub_name', methods=['GET','POST'])
def fanclub_name():
    return render_template('fanclub_name.html')
